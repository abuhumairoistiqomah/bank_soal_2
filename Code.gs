 ...
 *
 * Database Header:
 * ID | Grade | Subject | Chapter | Topic | Task_Name | Type | Link | Uploader | Academic_Year
 *
...
function normalizeHeader(header) {
  ...
  if (/^(academic_year|academic year|academicyear|tahun ajaran|tahun_ajaran)$/i.test(text)) {
    return "academicYear";
  }
